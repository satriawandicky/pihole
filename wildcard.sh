...
echo " \e[1m ................... \e[0m"
sleep 0.1
curl -o /etc/pihole/up-wildcard.txt https://raw.githubusercontent.com/satriawandicky/pihole/master/wildcard.txt
...
sleep 0.1
sort -u -o /etc/pihole/up-wildcard.txt /etc/pihole/wildcard.txt
echo "\n"
